...
export default function Resources() {
  const resources = [
    ...
    {
      title: "Apostolic Faith Church Vision Plan",
      description:
  ...
  return (
    <div className="bg-base-100 text-base-content font-montserrat pt-28 pb-20 px-6 md:px-20">
      <div className="max-w-6xl mx-auto text-center">
        {/* Header */}
        <h1 className="text-3xl md:text-5xl font-bold mb-6 pt-10">Apostolic Faith Church -Kiambaa Resources</h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {resources.map((item, index) => (
            <div
              key={index}
              className="bg-base-200 p-8  shadow-lg hover:shadow-2xl transition duration-300 flex flex-col items-start text-left"
            >
              {item.icon}
