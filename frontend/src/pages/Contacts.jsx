...
export default function ContactPage() {
  ...
  return (
    <div className="bg-base-200 min-h-screen pt-32 pb-16 px-6 md:px-20 font-montserrat">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-base-content/80">
                Apostolic Faith Church, Kiambaa, Kiambu County, Kenya
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="text-base-content/80 hover:text-primary transition"
              >
                +254 722 850 169
              </a>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="mailto:kiambaaafc@gmail.com"
                className="text-base-content/80 hover:text-primary transition"
              >
            ...
            <div className="pt-6">
              ...
              <div className="flex flex-col gap-3 text-sm">
                <a
                  href="https://www.facebook.com/Afckiambaa"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/afckiambaa"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-primary hover:text-primary-focus transition"
                >
                ...
                <a
                  href="https://www.tiktok.com/@afckiambaa"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-primary hover:text-primary-focus transition"
                >
                ...
                <a
                  href="https://www.youtube.com/@ApostolicFaithKiambaa"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-primary hover:text-primary-focus transition"
                >
          ...
          <form
            ...
            className="bg-base-100 shadow-xl rounded-2xl p-8 space-y-6 border border-base-300"
          >
            <div>
